	...
	<section>
		<div class="woobewoo-item woobewoo-panel">
			<div id="containerWrapper">
				<form
					id="wpfFiltersEditForm"
					data-table-id="<?php echo esc_attr( $this->filter['id'] ); ?>"
					data-href="<?php echo esc_attr( $this->link ); ?>"
				>
						...
						<ul class="wpfSub control-buttons">
							<li>
								<button id="buttonSave" class="button<?php echo $isWCLicense ? ' button-primary' : ''; ?>">
									...
									<span><?php echo esc_html__( 'Save', 'woo-product-filter' ); ?></span>
								</button>
							</li>
							<li>
								<button id="buttonDelete" class="button">
									<i class="fa fa-trash-o" aria-hidden="true"></i>
									<span><?php echo esc_html__( 'Delete', 'woo-product-filter' ); ?></span>
								</button>
							</li>
						</ul>
					</div>
						...
						<div class="woobewoo_row">
							...
							<div class="col-md-4 wpfShortcodeAdm woobewoo-flex-column">
								<label for="" class="woobewoo-d-flex woobewoo-items-center">
									...
									<i
										class="fa fa-question woobewoo-tooltip"
										title="<?php echo esc_attr( __( 'Using short code display the filter and products in the desired place of the template.', 'woo-product-filter' ) . ' <a href="' . esc_url( 'https://' . WPF_WP_PLUGIN_URL . '/documentation/how-to-add-woocommerce-product-filter-to-shop/' ) . '" class="wupsales-wc-hidden" target="_blank">' . __( 'Learn More', 'woo-product-filter' ) . '</a>' ); ?>"
									>
									</i>
								</label>
								<select
									name="shortcode_example"
									id="wpfCopyTextCodeExamples"
									class="woobewoo-flat-input woobewoo-wdt-100 woobewoo-max-width-100-i"
								>
							...
							<?php if ( $fid ) { ?>
								<div
									class="col-md-4 wpfCopyTextCodeShowBlock wpfShortcode shortcode woobewoo-flex-column">
									<label class="woobewoo-inline-block" for="">
					...
					<div class="">
						<div class="no-md-r-padding woobewoo-wdt-100">
							<div id="tabsContainer" class="woobewoo-d-flex wpfSub tabs-wrapper wpfMainTabs">
								<a href="#row-tab-filters" class="current button wpfFilters">
								...
								<a href="#row-tab-design" class="button">
									<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
										<path
											d="M9.99984 18.3333C5.40817 18.3333 1.6665 14.5917 1.6665 9.99999C1.6665 5.40832 5.40817 1.66666 9.99984 1.66666C14.5915 1.66666 18.3332 5.03332 18.3332 9.16666C18.3332 11.925 16.0915 14.1667 13.3332 14.1667H11.8582C11.6248 14.1667 11.4415 14.35 11.4415 14.5833C11.4415 14.6833 11.4832 14.775 11.5498 14.8583C11.8915 15.25 12.0832 15.7417 12.0832 16.25C12.0832 17.4 11.1498 18.3333 9.99984 18.3333ZM9.99984 3.33332C6.32484 3.33332 3.33317 6.32499 3.33317 9.99999C3.33317 13.675 6.32484 16.6667 9.99984 16.6667C10.2332 16.6667 10.4165 16.4833 10.4165 16.25C10.4165 16.1167 10.3498 16.0167 10.2998 15.9583C9.95817 15.575 9.77484 15.0833 9.77484 14.5833C9.77484 13.4333 10.7082 12.5 11.8582 12.5H13.3332C15.1748 12.5 16.6665 11.0083 16.6665 9.16666C16.6665 5.94999 13.6748 3.33332 9.99984 3.33332Z"
											fill="#636977"/>
										<path
											d="M5.4165 10.8333C6.10686 10.8333 6.6665 10.2737 6.6665 9.58332C6.6665 8.89297 6.10686 8.33332 5.4165 8.33332C4.72615 8.33332 4.1665 8.89297 4.1665 9.58332C4.1665 10.2737 4.72615 10.8333 5.4165 10.8333Z"
											fill="#636977"/>
										<path
											d="M7.9165 7.49999C8.60686 7.49999 9.1665 6.94035 9.1665 6.24999C9.1665 5.55963 8.60686 4.99999 7.9165 4.99999C7.22615 4.99999 6.6665 5.55963 6.6665 6.24999C6.6665 6.94035 7.22615 7.49999 7.9165 7.49999Z"
											fill="#636977"/>
										<path
											d="M12.0832 7.49999C12.7735 7.49999 13.3332 6.94035 13.3332 6.24999C13.3332 5.55963 12.7735 4.99999 12.0832 4.99999C11.3928 4.99999 10.8332 5.55963 10.8332 6.24999C10.8332 6.94035 11.3928 7.49999 12.0832 7.49999Z"
											fill="#636977"/>
										<path
											d="M14.5832 10.8333C15.2735 10.8333 15.8332 10.2737 15.8332 9.58332C15.8332 8.89297 15.2735 8.33332 14.5832 8.33332C13.8928 8.33332 13.3332 8.89297 13.3332 9.58332C13.3332 10.2737 13.8928 10.8333 14.5832 10.8333Z"
											fill="#636977"/>
									</svg>
					...
					<div
						...
						<div class="col-md-3 woobewooFiltersMainRightCol">
							<div class="hidden-lg hidden-md">
								<div
									class="wpfPreviewTitle"><?php echo esc_html__( 'Preview', 'woo-product-filter' ); ?></div>
							</div>
