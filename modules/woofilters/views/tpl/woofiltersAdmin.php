...
<section>
	<div class="woobewoo-item woobewoo-panel d-flex flex-column">
		<div class="topBtnsArea d-flex items-center justify-end">
			<a href="#wpfadd" class="btn btn-primary d-flex items-center">
		...
		<div class="d-flex items-center justify-between py-24">
			...
			<ul id="wpfTableTblNavBtnsShell" class="woobewoo-bar-controls m-0">
