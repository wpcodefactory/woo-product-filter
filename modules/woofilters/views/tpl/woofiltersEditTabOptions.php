...
?>
<div class="woobewoo_row woobewoo_row-tab" id="woobewoo_row-tab-options">
	...
	<div class="col-xs-12 sub-tab-content" id="sub-tab-options-main" data-no-preview="1">
		...
		?>
		<div class="woobewoo_row woobewoo_row-settings-block">
		...
		<div class="woobewoo_row woobewoo_row-settings-block <?php echo esc_attr($hiddenStyle); ?>" data-parent="settings[enable_ajax]">
			<div class="settings-block-label col-xs-4 col-lg-3">
...
?>
	...
	<div class="col-xs-12 sub-tab-content" id="sub-tab-options-buttons">
		...
		<?php
			...
			$hiddenStyle  = $settingValue ? '' : 'wpfHidden';
		?>
		<div class="woobewoo_row woobewoo_row-settings-block wpfTypeSwitchable">
			<div class="settings-block-label col-xs-4 col-lg-3">
	...
	<div class="col-xs-12 sub-tab-content" id="sub-tab-options-loader" data-no-preview="1">
		...
		?>
		<div class="woobewoo_row woobewoo_row-settings-block wpfLoader">
			<div class="settings-block-label col-xs-4 col-lg-3">
