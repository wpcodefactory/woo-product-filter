...
(function ($, app) {
  ...
  function wpfIsAjaxPaginationEnabled() {
    ...
    return !!(
      settings.settings &&
      (parseInt(settings.settings.ajax_pagination, 10) === 1 || parseInt(settings.settings.slug_format, 10) === 1)
    );
  }
  /**
   * WpfFrontendPage.
  ...
  WpfFrontendPage.prototype.init = function () {
    ...
    _thisObj.isAdminPreview =
      jQuery('#wpfFiltersEditForm').length > 0 ||
      (typeof isElementorPreview != 'undefined' && isElementorPreview == 1) ||
      wpfIsThriveEditor();
    ...
    // New logic from main branch for slug format
  ...
  WpfFrontendPage.prototype.eventsPriceFilter = function () {
    ...
    //change price range
    jQuery('.wpfFilterWrapper[data-filter-type="wpfPriceRange"] input, .wpfFilterWrapper[data-filter-type="wpfPriceRange"] select').on(
      'change',
      function (e) {
        e.preventDefault();
  ...
  WpfFrontendPage.prototype.eventsFrontend = function () {
    ...
    jQuery(
      '.wpfFilterWrapper[data-filter-type="wpfCategory"], .wpfFilterWrapper[data-filter-type="wpfPerfectBrand"], .wpfFilterWrapper[data-filter-type="wpfAttribute"]'
    ).each(function () {
    ...
    jQuery('body')
      .off('change', '.wpfFilterWrapper select, .wpfFilterWrapper input:not(.passiveFilter)')
      .on('change', '.wpfFilterWrapper select, .wpfFilterWrapper input:not(.passiveFilter)', function (e) {
        e.preventDefault();
    ...
    //uncheck one slug
    jQuery('body')
      .off('click', '.wpfSlugDelete')
      .on('click', '.wpfSlugDelete', function () {
        var _this = jQuery(this),
    ...
    jQuery('body')
      .off('click', '.wpfFilterWrapper .wpfFilterTitle')
      .on('click', '.wpfFilterWrapper .wpfFilterTitle', function (e) {
        e.preventDefault();
        var _this = jQuery(this),
    ...
    jQuery('body')
      .off('click', '.wpfFilterWrapper .wpfBlockClear')
      .on('click', '.wpfFilterWrapper .wpfBlockClear', function () {
    ...
    //ajax pagination
    jQuery('body')
      .off('click', '.woocommerce-pagination a.page-numbers')
      .on('click', '.woocommerce-pagination a.page-numbers', function (e) {
        var wrapper = jQuery('.wpfMainWrapper').first();
    ...
    jQuery('body')
      .off('click', '.wpfNoWooPage .woocommerce-pagination a.page-numbers')
      .on('click', '.wpfNoWooPage .woocommerce-pagination a.page-numbers', function (e) {
        e.preventDefault();
        var _this = jQuery(this),
          paginationWrapper = _this.closest('.woocommerce-pagination'),
          currentNumber = paginationWrapper.find('.current').text();
  ...
  WpfFrontendPage.prototype.filtering = function ($filterWrapper, clearAll, redirectLink, onlyRecalcFilter) {
    ...
    if ($filterWrapper.length !== 0) {
      ...
      _thisObj.isSynchro =
        $generalSettings['settings']['use_filter_synchro'] && $generalSettings['settings']['use_filter_synchro'] == '1' ? true : false;
      ...
      (_thisObj.isSynchro ? jQuery('.wpfMainWrapper') : $filterWrapper)
        .find('.wpfFilterWrapper:not(.wpfNotActive), .wpfFilterWrapper.wpfPreselected')
        .each(function () {
          var $filter = jQuery(this),
          ...
          if (
            (allSettings['backend'].length && typeof allSettings['backend'] !== 'undefined') ||
            filterType === 'wpfSearchText' ||
            filterType === 'wpfSearchNumber'
          ) {
      ...
      var $filterSettings =
        $generalSettings === false
          ...
          : {
              ...
              filter_recount:
                $generalSettings['settings']['filter_recount'] && $generalSettings['settings']['filter_recount'] == '1' ? true : false,
              filter_recount_price:
                $generalSettings['settings']['filter_recount_price'] && $generalSettings['settings']['filter_recount_price'] == '1'
                  ? true
                  : false,
              text_no_products: $generalSettings['settings']['text_no_products'] ? $generalSettings['settings']['text_no_products'] : '',
              count_product_shop: $generalSettings['settings']['count_product_shop']
                ? parseInt($generalSettings['settings']['count_product_shop'])
                : 0,
              f_multi_logic: $generalSettings['settings']['f_multi_logic'] ? $generalSettings['settings']['f_multi_logic'] : 'and',
              remove_actions:
                $generalSettings['settings']['remove_actions'] && $generalSettings['settings']['remove_actions'] == '1' ? true : false,
              filtering_by_variations:
                $generalSettings['settings']['filtering_by_variations'] && $generalSettings['settings']['filtering_by_variations'] == '1'
                  ? true
                  : false,
              form_filter_by_variations:
                $generalSettings['settings']['form_filter_by_variations'] &&
                $generalSettings['settings']['form_filter_by_variations'] == '1'
                  ? true
                  : false,
              exclude_backorder_variations:
                $generalSettings['settings']['exclude_backorder_variations'] &&
                $generalSettings['settings']['exclude_backorder_variations'] == '1'
                  ? true
                  : false,
              display_product_variations:
                $generalSettings['settings']['display_product_variations'] &&
                $generalSettings['settings']['display_product_variations'] == '1'
                  ? true
                  : false,
              all_products_filtering:
                $generalSettings['settings']['all_products_filtering'] && $generalSettings['settings']['all_products_filtering'] == '1'
                  ? true
                  : false,
              do_not_use_shortcut:
                $generalSettings['settings']['do_not_use_shortcut'] && $generalSettings['settings']['do_not_use_shortcut'] == '1'
                  ? true
                  : false,
              use_category_filtration: $generalSettings['settings']['use_category_filtration']
                ? $generalSettings['settings']['use_category_filtration']
                : 1,
              product_list_selector: $generalSettings['settings']['product_list_selector']
                ? $generalSettings['settings']['product_list_selector']
                : '',
              product_container_selector: $generalSettings['settings']['product_container_selector']
                ? $generalSettings['settings']['product_container_selector']
                : '',
              auto_update_filter: Number($generalSettings['settings']['auto_update_filter']),
              redirect_only_click: Number($generalSettings['settings']['redirect_only_click']),
              display_status_private:
                $generalSettings['settings']['display_status_private'] && $generalSettings['settings']['display_status_private'] == '1'
                  ? true
                  : false,
              ...
              display_only_children_category: $generalSettings['settings']['display_only_children_category']
                ? $generalSettings['settings']['display_only_children_category']
                : '',
            };
      ...
      $filterSettings['sort_by_title'] =
        $generalSettings['settings']['sort_by_title'] != undefined && $generalSettings['settings']['sort_by_title'] == '1' ? true : false;
      if (typeof $defQuery !== 'undefined' && $defQuery.length) $filterSettings['default_query'] = JSON.parse($defQuery);

      // find woocommerce product loop type ( shorcode, loop )
      var productContainerSelector = _thisObj.fixSelector($filterSettings['product_container_selector'], ''),
        productContainerElem = productContainerSelector !== '' ? jQuery(productContainerSelector) : jQuery(document);
      ...
      if (onlyRecalcFilter) {
        ...
        var requestData = _thisObj.getAjaxRequestData(
          $filtersDataBackend,
          $queryVars,
          $filterSettings,
          $generalSettings,
  ...
  WpfFrontendPage.prototype.getAjaxRequestData = function (
    $filtersDataBackend,
    $queryVars,
    $filterSettings,
    $generalSettings,
      ...
      if ($synchroFilters.length) {
        ...
        $filter.find('input:checked').each(function () {
          ...
          if ($li) {
            ...
            if ($synchroInput.length == 0 && filterDisplay == 'colors')
              $synchroInput = $synchroFilters.find('input[data-term-id="' + $li.attr('data-term-id') + '"]');
  ...
  WpfFrontendPage.prototype.changeLmpButton = function () {
    ...
    if (lmpBtn.length) {
      ...
      url = url.indexOf('/page/2') > -1 ? url : url.replace(/\/page\/[0-9]{1,}/gi, '/page/2');
      ...
      for (var i = 0; i < count; i++) {
        switch ($filtersDataFrontend[i]['id']) {
          ...
          case 'wpfCustomField':
            ...
            var cfValues = typeof settingsObj.settings !== 'undefined' ? settingsObj.settings : settingsObj[name];
          ...
          case 'wpfAttribute':
            ...
            if (typeof $filtersDataFrontend[i]['idBlock'] !== 'undefined' && typeof $filtersDataFrontend[i]['idFilter'] !== 'undefined') {
              _thisObj.QStringWork(
                'group' + product_taxonomy.replace('filter', '') + $filtersDataFrontend[i]['idBlock'],
                $filtersDataFrontend[i]['idFilter'],
                noWooPage,
                filterWrapper,
                'change'
              );
      ...
      if ($elem.length > 0) {
        ...
        if (jQuery('.wpfSlugWrapper').length > 0) {
          if (!jQuery('.wpfSlugWrapper .wpfSlug[data-slug="' + $slug + '"]').length > 0) {
            html +=
              '<div class="wpfSlug" data-slug="' +
              $slug +
              '" data-get-attribute="' +
              $getAttr +
              '" data-filter-type="' +
              $filterType +
              '"><div class="wpfSlugTitle">' +
              $label +
              '</div><div class="wpfSlugDelete">x</div></div>';
  ...
  WpfFrontendPage.prototype.sendFiltersOptionsByAjax = function (
    $filtersDataBackend,
    $queryVars,
    $filterSettings,
    $generalSettings,
    ...
    var ajax_leave_products =
      $generalSettings && $generalSettings['settings'] && $generalSettings['settings']['ajax_leave_products'] == '1';
    ...
    var productContainerElem = productContainerSelector !== '' ? jQuery(productContainerSelector) : jQuery(document);
        ...
        if (!res.error) {
          ...
          if (_thisObj.filterClick) {
            if (customListSelector !== '' && productListElem.length) {
              ...
              var catSelector = wpfGetSelector(
                  res.data['categoryHtml'],
                  true,
                  _thisObj.defaultProductSelector,
                  1,
                  false,
                  productContainerElem
                ),
                loopSelector = wpfGetSelector(
                  res.data['loopStartHtml'],
                  true,
                  _thisObj.defaultProductSelector,
                  3,
                  false,
              ...
              if (
                typeof jQuery('.product-categories-wrapper', productContainerElem) !== 'undefined' &&
                jQuery('.product-categories-wrapper > ul.products', productContainerElem).length > 0
              ) {
                //replace cats html
                ...
                jQuery('.woocommerce > .products[data-filterargs][data-innerargs]', productContainerElem).html(
                  res.data['categoryHtml'] + res.data['productHtml']
                );
              } else {
                if (!loopContainer.length) {
                  if (
            ...
            var countSelector = wpfGetSelector(
                res.data['resultCountHtml'],
                true,
            ...
            var isLeerPagination = res.data['paginationHtml'] == '',
              paginationSelector = wpfGetSelector(
                res.data[isLeerPagination ? 'paginationLeerHtml' : 'paginationHtml'],
                false,
  ...
  WpfFrontendPage.prototype.ajaxForceThemeTemplates = function (
      ...
      success: function (data) {
        ...
        block.each(function (index, value) {
          ...
          blockWhere.html(
            blockWhat
              .html()
              .replace(/wpf_skip=1/g, '')
              .replace(/wpf_fid=[0-9]*/g, '')
              .replace(/&amp;&amp;/g, '&amp;')
          );
          ...
          if (!paginationPageBlock.length) {
            ...
            if (paginationResponse.length) {
              ...
              if (paginationPage.length) {
                ...
                jQuery(blockWhere)
                  .parent()
                  .after('<nav class="woocommerce-pagination">' + paginationResponse + '</nav>');
              }
  ...
  WpfFrontendPage.prototype.ajaxOnlyRecount = function (requestData, filterId, $wrapperSettings) {
    ...
    if (!_thisObj.currentAjaxJSLoaded && requestData) {
      ...
      jQuery.sendFormWpf({
        ...
        onSuccess: function (res) {
          if (
            typeof $wrapperSettings !== 'undefined' &&
  ...
  WpfFrontendPage.prototype.afterAjaxFiltering = function ($wrapperSettings) {
    ...
    if (
      jQuery(_thisObj.defaultProductSelector).closest('.et_pb_shop').length &&
      jQuery(_thisObj.defaultProductSelector).find('[loading="lazy"]').length == 0
    ) {
  ...
  WpfFrontendPage.prototype.enableFiltersLoader = function (idWrapper, productListElem) {
    var preview = jQuery('#' + idWrapper + ' .wpfPreviewLoader')
      .first()
      .clone()
      .removeClass('wpfHidden');
      ...
      switch (filterType) {
        ...
        case 'wpfPrice':
          ...
          if (skin === 'default') {
            ...
            var sliderCurBefore =
              $filter.attr('data-slider-currency-before') != undefined ? $filter.attr('data-slider-currency-before') : '';
    ...
    if (filterType === 'dropdown') {
      ...
      $filter.find('input').each(function () {
        ...
        if (jQuery(this).is(':checked')) {
          ...
          selectedOptions['list'][id] = name;
          statistics.push(
            liCurent.find('.wpfFilterTaxNameWrapper:first').length ? liCurent.find('.wpfFilterTaxNameWrapper:first').html() : name
          );
          i++;
        }
      });
...
function wpfChangeFiltersCount(wpfExistTerms, synchroFilterId) {
  var wpfPage = window.wpfFrontendPage,
    curFilter = wpfPage.isSynchro
      ? typeof synchroFilterId != 'undefined' && synchroFilterId.length
        ? '#' + synchroFilterId
        : '#' + wpfPage.currentLoadId
      : 'body';

  jQuery(curFilter).find('.wpfShowCount').find('.wpfCount').html('(0)');
  jQuery(curFilter)
    .find('.wpfShowCount select:not([multiple]) option[data-count]')
    .each(function () {
  ...
  jQuery(curFilter)
    .find('.wpfShowCount select[multiple]')
    .find('option')
    .each(function () {
      ...
      if (filter.attr('data-filter-type').length > 0) {
        ...
        if (taxonomy in wpfExistTerms) {
          if (typeof wpfExistTerms[taxonomy].relation !== 'undefined') {
            var htmlArray = {};
            jQuery(curFilter)
              .find('div.wpfShowCount[data-taxonomy="' + taxonomy + '"] li')
              .each(function () {
          ...
          if (taxonomy in wpfExistTerms || isFilterCurentlyActivated) {
            ...
            filter.find('[data-term-id]').each(function () {
              var elem = jQuery(this),
                ...
                selected =
                  isFilterCurentlyActivated &&
                  (elem.is('input:checked') || elem.find('input:checked').length || elem.is('option:selected'));
