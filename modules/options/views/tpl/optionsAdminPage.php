			...
			<div>
				<form id="tableForm">
					<div class="wpfPopupBlock">
						<label class="wpfPopupLabel">
							<?php esc_html_e('Filter name', 'woo-product-filter'); ?>
						</label>
						<input id="addDialog_title" class="woobewoo-text woobewoo-width-full" type="text" placeholder="e.g. Shop Sidebar Filter" />
					</div>
					<div class="wpfPopupBlock">
						<label class="wpfPopupLabel">
							<?php esc_html_e('Choose filter types ', 'woo-product-filter'); ?>
							<span>
								<?php esc_html_e('(You can change them later)', 'woo-product-filter'); ?>
							</span>
						</label>
