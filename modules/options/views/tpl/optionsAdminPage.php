				...
				<ul>
					<?php foreach ($this->tabs as $tabKey => $t) { ?>
						...
						<li class="woobewoo-tab-<?php echo esc_attr($tabKey); ?> <?php echo (($this->activeTab == $tabKey || in_array($tabKey, $this->activeParentTabs)) ? 'active' : ''); ?>">
							<a class="menuItem woobewoo-d-inline-block woobewoo-wdt-100" href="<?php echo esc_url($t['url']); ?>" title="<?php echo esc_attr($t['label']); ?>" <?php echo empty($t['blank']) ? '' : ' target="_blank"'; ?>>
