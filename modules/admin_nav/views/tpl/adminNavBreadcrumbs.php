...
<nav id="woobewoo-breadcrumbs" class="woobewoo-breadcrumbs 
	<?php DispatcherWpf::doAction('adminBreadcrumbsClassAdd'); ?>">
	<?php DispatcherWpf::doAction('beforeAdminBreadcrumbs'); ?>
	<?php foreach ($this->breadcrumbsList as $i => $crumb) { ?>
		<a class="woobewoo-breadcrumb-el" href="<?php echo esc_url($crumb['url']); ?>">
