...
class WooBeWoo_PF_Html {
	...
	public static function email( $name, $params = array(
		'attrs' => '',
		'value' => '',
	) ) {
		$params['type'] = 'email';
	...
	public static function reset( $name, $params = array(
		'attrs' => '',
		'value' => '',
	) ) {
		$params['type'] = 'reset';
	...
	public static function password( $name, $params = array(
		'attrs' => '',
		'value' => '',
	) ) {
	 ...
	 * @version 3.1.8
	 */
	public static function checkboxToggle(
		$name,
		$params = array(
			'attrs'   => '',
			'value'   => '',
	...
	public static function buttonA( $params = array(
		'attrs' => '',
		'value' => '',
	) ) {
		echo '<a href="#" ';
	...
	public static function categorySelectlist( $name, $params = array(
		'attrs' => '',
		'size'  => 5,
		'value' => '',
	) ) {
	...
	public static function categorySelectbox( $name, $params = array(
		'attrs' => '',
		'size'  => 5,
		'value' => '',
	) ) {
	...
	public static function productsSelectlist( $name, $params = array(
		'attrs' => '',
		'size'  => 5,
		'value' => '',
	) ) {
	...
	public static function productsSelectbox( $name, $params = array(
		'attrs' => '',
		'size'  => 5,
		'value' => '',
	) ) {
	...
	public static function colorpicker( $name, $params = array( 'value' => '' ) ) {
		...
		self::text(
			...
			array(
				'value' => $value,
				'attrs' => ' data-alpha="true" class="woobewoo-color-result"',
			)
		);
		self::text(
			$name,
			array(
				'value' => $value,
				'attrs' => 'class="woobewoo-color-result-text"',
			)
		);
		echo '</div>';
	}

	public static function checkboxHiddenVal(
		$name,
		$params = array(
			'attrs'   => '',
			'value'   => '',
